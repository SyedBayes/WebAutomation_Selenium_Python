...
#form fillup
driver.find_element("xpath",'//*[@id="form"]/div/div/div[3]/div/form/input[2]').send_keys("Syed Bayes Iqbal")
driver.find_element("xpath",'//*[@id="form"]/div/div/div[3]/div/form/input[3]').send_keys("bayes29@gmail.com")#need to change email everytime before run
...
driver.find_element("xpath",'//*[@id="password"]').send_keys("bayes123")
